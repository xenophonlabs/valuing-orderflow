\section{Introduction} \label{section:intro}
    ...
    % We provide protocol recommendations and directions for future research in section \ref{section:discussion}, and we conclude this research in section \ref{section:conclusion}.