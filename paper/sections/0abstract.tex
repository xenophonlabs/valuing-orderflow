\begin{abstract}
    ...
    We analyze how \textit{uninformed orderflow} -- orders that are not predictive of future price movements -- affect the revenue earned by liquidity providers on the Uniswap Protocol.
    We also present an opinionated framework for how much the protocol should value liquidity.
    We conclude by providing a recommended upper bound on how much the protocol should pay for uninformed orderflow.
\end{abstract}